...
public final class JsonParser {
    ...
    public static final class JsonParserContext<T> {
        ...
        public T from(ByteBuf buf) throws JsonParserException {
            return new JsonParser(new JsonTokener(buf), lazyNumbers).parse(clazz);
        }
    ...
    private JsonParser(JsonTokener tokener, boolean lazyNumbers) {
